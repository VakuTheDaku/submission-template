...
export default function View({ getContract }) {
    ...
    const fetchAllRecords = async () => {
        ...
        const newRecords = allRecords.filter((record) => {
            ...
            if ((String(record[1]).toUpperCase() === String(state.patient_pubkey).toUpperCase())) {
                return record
            }
            else {
                return
                    ...
                    <div className="shadow-lg rounded-md bg-black bg-opacity-25 pt-10 border border-5 border-white rounded-md p-10">
                        ...
                        <div className="grid place-items-center gap-3 mt-2">
                            ...
                            <label className="input-group ">
                                <span className="label border text-xsm w-1/3 text-white">Patient Pub Key</span>
                            ...
                            <div className="grid place-items-center gap-4">
                                {records ? <div className="bg-amber-200 border-b text-black px-5 py-3 mb-3 rounded-md border-b-4">
                                    RECORDS
